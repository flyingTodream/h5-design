...
// 请求拦截器
Axios.interceptors.request.use(requestFn, requestErrFn);
// 响应拦截器
Axios.interceptors.response.use(responseFn, responseErrFn);
Upload.interceptors.response.use(responseFn, responseErrFn);
PsdUpload.interceptors.response.use(responseFn, responseErrFn);
export { Axios, Upload, PsdUpload };
