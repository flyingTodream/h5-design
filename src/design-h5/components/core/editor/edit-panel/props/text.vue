<template>
  <div class="design-config">
    <!-- <VxToolBar :class="{'image-disable': locked}" :index="index"></VxToolBar> -->
    <div>
      <div class="font-panel">
        ...
        <div class="font-panel-image">
          ...
          <VxColorPicker class="font-color-picker"></VxColorPicker>
        </div>
      </div>
      <div class="font-text">
        ...
        <div class="font-text-family">
          ...
          <vx-icon
            ...
            name="deleteline"
          ></vx-icon>-->
          <!-- <vx-icon title="加粗" name="blod"></vx-icon> -->
          <vx-icon title="斜体" name="italic"></vx-icon>
          <vx-icon title="下划线" name="underline"></vx-icon>
          <vx-icon title="删除线" name="deleteline"></vx-icon>
        </div>
        ...
        <div class="font-text-family">
          ...
          <div class="font-word-space">
            ...
            <div class="slider">
              <el-slider :min="-50" :max="120"></el-slider>
            </div>
            <div class="value">{{}}</div>
          </div>
          ...
          <div class="font-word-space">
            ...
            <div class="slider">
              <el-slider :min="1" :max="50"></el-slider>
            </div>
            <div class="value">{{}}</div>
          </div>
        </div>
        <vx-select @edit="editAbleHandler" :minValue="12" :maxValue="500">
        ...
        <div class="font-text-range">
          <div class="font-range-input">
            ...
            <div class="font-range">
              <el-slider :min="0" :max="10"></el-slider>
            </div>
            <div class="font-range-value">{{}}</div>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    isBold: {
      get() {
        return this.editingElement.commonStyle.fontWeight !== 400
      },
      set(newValue) {
        if (newValue) {
          ...
          // this.editingElement.commonStyle.fontWeight = 600
        } else {
          this.setElementShape({
            fontWeight: 400
          })
          // this.editingElement.commonStyle.fontWeight = 400
        }
      }
    }
    //     isUnderline: {
  ...
  methods: {
    ...mapActions('editor', ['setElementShape']),
    editAbleHandler() {
